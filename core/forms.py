...
class TourForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'descripcion': forms.Textarea(attrs={'class': 'w-full p-3 border border-slate-200 rounded-xl outline-none focus:border-primary', 'rows': 3, 'placeholder': 'Resumen breve del tour'}),
            'descripcion_experiencia': forms.Textarea(attrs={'class': 'w-full p-3 border border-slate-200 rounded-xl outline-none focus:border-primary', 'rows': 8, 'placeholder': 'Describe el recorrido completo del tour'}),
            'incluye': forms.Textarea(attrs={'class': 'w-full p-3 border border-slate-200 rounded-xl outline-none focus:border-primary', 'rows': 5, 'placeholder': 'Un item por linea'}),
            'no_incluye': forms.Textarea(attrs={'class': 'w-full p-3 border border-slate-200 rounded-xl outline-none focus:border-primary', 'rows': 5, 'placeholder': 'Un item por linea'}),
            'recomendaciones': forms.Textarea(attrs={'class': 'w-full p-3 border border-slate-200 rounded-xl outline-none focus:border-primary', 'rows': 5, 'placeholder': 'Un item por linea'}),
            'informacion_importante': forms.Textarea(attrs={'class': 'w-full p-3 border border-slate-200 rounded-xl outline-none focus:border-primary', 'rows': 6, 'placeholder': 'Un item por linea'}),
            'nota_importante': forms.Textarea(attrs={'class': 'w-full p-3 border border-slate-200 rounded-xl outline-none focus:border-primary', 'rows': 4, 'placeholder': 'Aclaraciones finales del tour'}),
            ...
            'idiomas': forms.TextInput(attrs={'class': 'w-full p-3 border border-slate-200 rounded-xl outline-none focus:border-primary', 'placeholder': 'Ej. Espanol / Ingles'}),
            'nivel_dificultad': forms.TextInput(attrs={'class': 'w-full p-3 border border-slate-200 rounded-xl outline-none focus:border-primary', 'placeholder': 'Ej. Facil'}),
            ...
            'ocultar_precio': forms.CheckboxInput(attrs={'class': 'h-5 w-5 rounded border-slate-300 text-primary'}),
